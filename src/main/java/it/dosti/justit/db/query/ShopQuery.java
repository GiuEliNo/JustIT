...
public class ShopQuery {
    ...
    public static final String SELECT_ALL_SHOPS = "SELECT id, name, address, phone, email, description, image, openingHours, homeAssistance, latitude, longitude FROM Shop";
