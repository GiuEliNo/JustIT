...
public class AccountController {
    ...
    public UserBean getUserBean(SessionBean session) {
        ...
        if (user instanceof ClientUser clientUser) {
            ...
            userBean.setAddress(clientUser.getAddress());
    ...
    public boolean editName(SessionBean session, UserBean userBean) throws UserNotFoundException, UpdateOnBackEndException {
        UpdateController updateController = new UpdateController();
        return updateController.updateName(session, userBean.getName());
    }
    public boolean editEmail(SessionBean session, UserBean userBean) throws UserNotFoundException, UpdateOnBackEndException {
        UpdateController updateController = new UpdateController();
